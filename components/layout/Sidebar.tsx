...
function NavItems({ items, pathname }: { items: { label: string; icon: any; href: string }[]; pathname: string }) {
  return (
    <>
      {items.map(item => {
...
export default function Sidebar({ profile }: { profile: Profile }) {
  ...
  const NAV_ITEMS: Record<string, { label: string; icon: any; href: string }[]> = {
    admin: [
