  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      <div>
        ...
        <p style={{ fontSize: '13px', color: '#6B7280', margin: '4px 0 0' }}>Reply to customers on the business WhatsApp — filter by your country, track status.</p>
      </div>
      <InboxClient currentUserId={user.id} reps={reps} countries={countries} rolePrefix="/sales" />
    </div>
  )
}
