// app/(dashboard)/admin/calendar/mine/page.tsx
import { createClient } from '@/lib/supabase/server'
import { redirect } from 'next/navigation'
import CalendarClient from '../CalendarClient'

export default async function AdminMyCalendarPage() {
  ...
  const [
    { data: sessionTypes }, { data: teacherRows }, { data: students }, { data: supervisorRows },
  ] = await Promise.all([
