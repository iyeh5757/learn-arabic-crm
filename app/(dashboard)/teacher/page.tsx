...
export default async function TeacherDashboard() {
  ...
  const attendedPaid = monthSessions.filter((s: any) => s.session_type === 'paid' && (s.attendance_status === 'attended' || s.attendance_status === 'no-show'))
  const attendedTrials = monthSessions.filter((s: any) => s.session_type === 'trial' && (s.attendance_status === 'attended' || s.attendance_status === 'no-show') && s.student?.student_status === 'active' && s.student?.payment_status === 'paid')
