...
const NAV: Record<string, { label: string; href: string; emoji: string }[]> = {
  admin: [
    ...
    { label: 'My Calendar',    href: '/admin/calendar/mine', emoji: '🗓️' },
  ...
  sales: [
    ...
    { label: 'My Calendar', href: '/sales/calendar/mine', emoji: '🙋' },
  ...
  supervisor: [
    ...
    { label: 'My Calendar', href: '/supervisor/calendar/mine', emoji: '🙋' },
