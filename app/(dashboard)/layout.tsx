...
const NAV: Record<string, { label: string; href: string; emoji: string }[]> = {
  admin: [
    ...
    { label: 'Team Inbox',     href: '/admin/inbox',        emoji: '💬' },
    ...
    { label: 'Team Analysis',  href: '/admin/supervisor-analysis', emoji: '📊' },
    { label: 'Sales Salary',   href: '/admin/team-performance', emoji: '💼' },
  ...
  sales: [
    ...
    { label: 'Team Inbox',  href: '/sales/inbox',       emoji: '💬' },
  ...
  supervisor: [
    ...
    { label: 'Team Analysis', href: '/supervisor/analysis', emoji: '📊' },
